#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To FSofficial
...
",:::      ,":::::          ' ··,::,::,'_._._._._._._._._._', 
      ...
      ,"::                          ,":::::::::",            ", 
     ,"::                          ,":::::::::::",            "
   |___'|.·´    FS_official of buner     -«
\033[1;97m:•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;94mFS_official\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•
\033[1;96m:•◈•
╔══╗────────────╔╗───────╔╗
║╔╗║────────────║║───────║║
║╚╝╚╦╗╔╦═╗╔══╦═╗║╚═╦══╦══╣║╔╦══╦═╗
...
\033[1:96m┃┃╱┃┃╭━╮┃╰━╯┃┃┃╰┫╰━━┫┃┃╰╮
\033[1;96m╰╯╱╰┻╯╱╰┻━━━┻╯╰━┻━━━┻╯╰━╯
\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mFS_official\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"""
jalan("\033[1;96m----------------------//\\")
jalan("\033[1;96m---------------------// ¤ \\")
jalan("\033[1;96m---------------------\\ ¤ //")
jalan("\033[1;96m---------------------- \\//")
...
jalan('\033[1;93m              Welcome to FS official')
print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;96mFS_official\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:FS_official
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;93mFS_official\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:FS_official
	print logo
...
def pilih_super():
	...
	p = ThreadPool(50)
	p.map(main, id)
	print "\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mFS_official\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;93m«---•◈•---Developed By baloch-Hacker--•◈•---»" #Dev:FS_official
	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Fazlisubhan.py)↩\033[1;97m....'
...
•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;96m ....Buner hacker  FS_official....... \033[1;93m :
•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                WhatsApp Num
              \033[1;96m +923129390417"""
